...
import 'package:bio_medika/views/account_info/widget/camera_icon.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class AccountInformationvatar extends StatelessWidget {
  const AccountInformationvatar({super.key});
          ...
          child: Stack(
            ...
            children: [
              Container(
                ...
                child: GetBuilder<UpImageAndNameControllerImp>(
                    builder: (controller) {
